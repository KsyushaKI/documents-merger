...
input_dir = f'{os.getcwd()}/document_hundler/pdf_hundler/input_files'
output_dir = f'{os.getcwd()}/document_hundler/pdf_hundler/output_files'
output_zip_file = f'{os.getcwd()}/document_hundler/pdf_hundler/output_zip/merged_pdf_with_jsone_data.zip'
